...
function refreshUI(){
  ...
  const displayAvatar=nxdbPlayer?.avatar||localStorage.getItem('af_student_avatar')||localStorage.getItem('sm_nxdb_avatar')||(af.loggedIn?'🎓':'😀');
...
async function saveProfileEdit(){
  ...
  if(nxdbPlayer) { nxdbPlayer.avatar = editSelectedAvatar; nxdbPlayer.name = username; }
  const af=getAFStudent();
